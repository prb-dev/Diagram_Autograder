prompts = {
    "class": (
        "Respond with only a valid JSON object for the given class diagram image. Do not include any explanations, introductions, or additional text. The JSON object must strictly follow this format:\n"
    ...
    "usecase": (
        "Respond with only a valid JSON object for the given use case diagram image. Do not include any explanations, introductions, or additional text. The JSON object must strictly follow this format:\n"
    ...
    "er": (
        "Respond with only a valid JSON object for the given er diagram image. Do not include any explanations, introductions, or additional text. The JSON object must strictly follow this format:\n"
    ...
    "sequence": (
        "Respond with only a valid JSON object for the given sequence diagram image. Do not include any explanations, introductions, or additional text. The JSON object must strictly follow this format:\n"
